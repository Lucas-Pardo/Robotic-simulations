...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Simulate robot movement in different environments.")
    parser.add_argument("--environment_type", "-e", type=int, default=1, choices=[1, 2], help="Type of environment (1 or 2).")
    parser.add_argument("--robot_type", "-r", type=int, default=1, choices=[1, 2], help="Type of robot (1 or 2).")
    parser.add_argument("--obstacle_number", "-o", type=int, default=4, help="Number of obstacles in the environment.")
    parser.add_argument("--env_limit", "-l", type=int, default=20, help="Limit of the environment.")
